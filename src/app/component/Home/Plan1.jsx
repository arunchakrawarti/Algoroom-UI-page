...
const Plan1 = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto">

      {/* Free Plan */}
      <div
        className="bg-white rounded-2xl shadow-[0px_7px_29px_0px_rgba(100,100,111,0.2)] p-6 flex flex-col items-center text-gray-700 w-full"
        style={{ animation: "slideFromLeft 1s ease-out forwards" }}
      >
        <h1 className="text-base font-bold uppercase tracking-widest text-black mb-6 mt-5">FREE</h1>
        <img
        ...
        />
        <p className="text-2xl font-bold border-b-4 border-blue-400 text-black inline-block pb-4">
          ₹0/day
        </p>
        <ul className="mt-6 space-y-2 text-sm text-left px-2 sm:px-5 text-gray-500 w-full">
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>50 Backtest Credit Points</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>5 Strategy Creation</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>No Basic+HNI & Retail Strategy Template Access</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>Reporting Console</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>No Strategy Deployment (Live & Forward)</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>No Portfolio Backtesting</li>
        </ul>
        <button className="mt-8 bg-blue-600 hover:bg-blue-950 text-white py-2 px-8 rounded-3xl shadow-lg">
          GET STARTED
        </button>
      </div>
      ...
      >
        ...
        <ul className="mt-6 space-y-2 text-sm text-left px-2 sm:px-5 text-gray-500 w-full">
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>1500 Backtest Credit Points</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>50 Strategy Creation</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>Basic+HNI & Retail Strategy Template Access</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>Reporting Console</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>20 Strategy Deployment (Live & Forward)</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>10 Portfolio Backtesting</li>
        </ul>
        <button className="mt-8 bg-blue-600 hover:bg-blue-950 text-white py-2 px-8 rounded-3xl shadow-lg">
          GET STARTED
        </button>
      ...
      <div
        ...
        style={{ animation: "slideFromLeft 1s ease-out forwards", animationDelay: "0.4s" }}
      >
        <h1 className="text-base font-bold uppercase tracking-widest text-black mb-6 mt-5">Limited Plan</h1>
        <img
          src="https://algorooms.com/images/b1y.svg"
          alt="Limited Plan"
        ...
        <ul className="mt-6 space-y-2 text-sm text-left px-2 sm:px-5 text-gray-500 w-full">
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>500 Backtest Credit Points</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>20 Strategy Creation</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>Basic+HNI & Retail Strategy Template Access</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>Reporting Console</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>15 Strategy Deployment (Live & Forward)</li>
          <li><span className='pr-2 text-blue-800 font-extrabold'>✔</span>8 Portfolio Backtesting</li>
        </ul>
        <button className="mt-8 bg-blue-600 hover:bg-blue-950 text-white py-2 px-8 rounded-3xl shadow-lg">
          GET STARTED
        </button>
