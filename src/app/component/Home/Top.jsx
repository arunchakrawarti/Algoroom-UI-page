...
const Top = () => {
  return (
    <div className="bg-gradient-to-r  from-blue-900 to-blue-400 mt-11 relative   h-auto sm:h-[450px] md:h-[600px] rounded-bl-sm [clip-path:polygon(0_0,100%_0,100%_20%,100%_89%,77%_100%,19%_100%,0_87%,0%_20%)]">
